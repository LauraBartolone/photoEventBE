...
from events.views import BackendPhotoModelViewSet, BackendBoardMessageModelViewSet, BackendAllPhotoModelViewSet
...
router_events.register(r'all-photos', BackendAllPhotoModelViewSet)
